...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/kabir-suri-211b1b243/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@CodingKabs",
    icon: Instagram,
    url: "https://www.instagram.com/codingkabs",
    color: "#E4405F",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@codingkabs",
    color: "black",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[instagram, tiktok].map((link, index) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative flex flex-col items-center text-center gap-3 p-4 rounded-xl 
                               bg-white/5 border border-white/10 overflow-hidden
                               hover:border-white/20 transition-all duration-500"
              data-aos="fade-up" 
        ...
        {/* Third Row removed (GitHub & TikTok) */}
      </div>
    </div>
  );
};
