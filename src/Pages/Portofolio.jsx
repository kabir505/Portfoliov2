...
export default function FullWidthTabs() {
  ...
  const fetchData = useCallback(async () => {
    try {
      // --- PROJECTS: try lowercase first, then quoted PascalCase
      ...
      // Normalize to the props your components expect
      const projectData = (p.data || []).map(r => ({
        id: r.id,
      ...
      const certificateData = (c.data || []).map(r => ({
        id: r.id,
        Img: r.Img ?? r.img ?? '',
      }));
    ...
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden" id="Portofolio">
      ...
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        ...
        <p className="text-slate-400 max-w-2xl mx-auto text-sm md:text-base mt-2">
          Discover my projects, achievements, and technical skills. Each piece represents my passion for creating
